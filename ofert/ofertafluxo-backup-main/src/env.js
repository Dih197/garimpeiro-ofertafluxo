...
export function loadEnv(file = '.env', override = false) {
...
export function config() {
  ...
  return {
    shopee: {
      // O painel nativo é incorporado ao Garimpeiro. Aceita tanto os nomes
      // originais deste módulo quanto as variáveis já usadas pela plataforma.
      url: process.env.SHOPEE_API_URL || process.env.SHOPEE_AFFILIATE_API || 'https://open-api.affiliate.shopee.com.br/graphql',
      appId: process.env.SHOPEE_APP_ID,
      secret: process.env.SHOPEE_SECRET || process.env.SHOPEE_PARTNER_KEY,
      extraHeaders,
